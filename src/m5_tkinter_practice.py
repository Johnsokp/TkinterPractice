...
def main():
    ...
    hg_button = ttk.Button(frame1, text='Test for ok')
    hg_button['command'] = lambda: check_for_ok(my_entry_box)
    hg_button.grid()
    # ------------------------------------------------------------------
    # TODO: 7.
    ...
    third_button = ttk.Button(frame1, text='Number')
    third_button['command'] = lambda: print_times(my_entry_box,
                                                   second_entry_box)
    third_button.grid()
...
def print_times(my_entry_box, second_entry_box):
    contents = my_entry_box.get()
    times = second_entry_box.get()
